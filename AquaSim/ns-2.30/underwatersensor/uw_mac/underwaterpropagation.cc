...
public:
	UnderwaterPropagationClass() :
			TclClass("Propagation/UnderwaterPropagation") {
	}
...
int UnderwaterPropagation::command(int argc, const char* const * argv) {
	TclObject *obj;
...
double UnderwaterPropagation::Pr(PacketStamp * t, PacketStamp * r,
		UnderwaterPhy * ifp) {
...
double UnderwaterPropagation::Attenuation(double d, double k, double f) {
...
double UnderwaterPropagation::Thorp(double f) {
