...
set ptype(goal_req) 75\n\
set pvals(75) GOAL_REQ\n\
set ptype(goal_rep) 76\n\
set pvals(76) GOAL_REP\n\
set ptype(goal_ack) 77\n\
set pvals(77) GOAL_ACK\n\
set ptype(protoname) 78\n\
set pvals(78) protoname\n\
proc ptype2val {str} {\n\
global ptype\n\
